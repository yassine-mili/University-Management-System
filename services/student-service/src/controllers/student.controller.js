...
function validateStudentData(data) {
    ...
    if (!data.numero_etudiant || typeof data.numero_etudiant !== 'string' || !data.numero_etudiant.trim()) {
    ...
    try {
        ...
        const student = await prisma.student.create({
            data: {
                ...
                date_naissance: req.body.date_naissance ? new Date(req.body.date_naissance) : null,
...
exports.updateStudent = async (req, res) => {
    ...
    try {
        ...
        const updateData = {};
        if (req.body.numero_etudiant !== undefined) updateData.numero_etudiant = req.body.numero_etudiant.trim();
        ...
        if (req.body.prenom !== undefined) updateData.prenom = req.body.prenom.trim();
        if (req.body.niveau !== undefined) updateData.niveau = req.body.niveau.trim();
        if (req.body.date_naissance !== undefined) updateData.date_naissance = req.body.date_naissance ? new Date(req.body.date_naissance) : null;
        if (req.body.filiere !== undefined) updateData.filiere = req.body.filiere ? req.body.filiere.trim() : null;
        if (req.body.est_actif !== undefined) updateData.est_actif = req.body.est_actif;
